...
<?php
    $sqlQuery = "SELECT storeid,storename,region,staffid,phonenumber FROM store ";
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="text-center">
                <a href="admin_stores_add.php" class="btn btn-primary btn-lg">Add Store</a>
            </div>
            <br class="mb-3">
            <table id="editableTable" class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                    <td><?php echo $user['storeid']; ?></td>
                    <td><?php echo $user['storename']; ?></td>
                    <td><?php echo $user['region']; ?></td>
                    <td><?php echo $user['staffid']; ?></td>
                    <td><?php echo $user['phonenumber']; ?></td>
                    <td><a href="admin_stores_update.php?id=<?php echo $user['storeid'];?>">edit/delete</a></td> 				   				   				  
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
